...
$SKILL_DIR = Join-Path $CONFIG_DIR "skills\tuhucr"
...
# 5. 生成 tuhucr Skill
Write-Host "🧠 正在生成 tuhucr Code Review 技能..." -ForegroundColor Yellow
...
Write-Host "💡 现在你可以在 OpenCode 中直接对我说: `"帮我用 tuhucr 审核一下这段代码，需求在 <Wiki链接>`"" -ForegroundColor Green